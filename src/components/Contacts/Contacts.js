                  ...
                  <div className={cl("contacts__element-first")}>
                    ...
                    <div className={cl("contacts__text")}>
                      {item.phone.map((el,index) => {
                        return <a className={cl("contacts__links")} href={"tel:" + el} key={index}>{el}</a>
                      })}
                    </div>
                  </div> :
                <></>
              }
              <div className={cl("contacts__element-second")}>
                  { item.email ?
                  <div className={cl("contacts__wrapper")}>
                    <Mail_Icon cssClass={cl("contacts__icon")}/>
                    <div className={cl("contacts__text")}>
                      <a className={cl("contacts__links")} href={"mailto:" + item.email}>{item.email}</a>
                    </div>
                    </div>
                    :
                  <></>
                    ...
                    item.socials.map((sc) => {
                      return (
                        <div className={cl("contacts__wrapper")} key={sc.socialName}>
                          ...
                          <div className={cl("contacts__text")}>
                            <a className={cl("contacts__links")} href={sc.socialLink}>{sc.socialLink}</a>
                          </div>
                        </div>
                      )
                  })
