      ...
      programs.map( program => {
        return(
          <div className={cl("program")}>
            <picture>
              <img className={cl("program__image")} src={program.image.src} alt={program.image.alt} title={program.image.alt}/>
            </picture>
            <Link href={program.link}>
              <a className={cl("program__link")} title={"Посмотреть подробнее про " + program.title}>
