...
const Uprazhneniya_Page = ({social, navShow}) => {
  ...
  const data = {
    ...
    'content': {
      h1: 'Программы',
      description: 'Русский силомер поможет вам выйти на новый урвень спортивной силы и выносливости',
      programs:[
        {
          title:'start +',
          description: 'программа тренировок для начинающих спортсменов и желающих улучшить свои навыки в работе с турником',
          image: {
